...
class SearchAdapter(options: FirestoreRecyclerOptions<post>,private val listener: SearchFragment) : FirestoreRecyclerAdapter<post, SearchAdapter.viewHolder>(
    options
) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): viewHolder {
        val viewholder=viewHolder(LayoutInflater.from(parent.context).inflate(R.layout.postview,parent,false))
